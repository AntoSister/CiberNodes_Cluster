...
class OrbitalSimulation(Simulation):
    ...
    def __download_satellite_tle(self):
        ...
        try:
            ...
            print(f"ERROR: Failed to download or load TLE from {norad_url}: {e}")
            satellite_list = []
        ...
        if len(satellite_list) > 0:
            ...
            print("WARNING: Satellite TLE not found or invalid. Using fallback TLE (ISS).")
            # TLE de la ISS (Estable y confiable para pruebas)
            line1 = '1 25544U 98067A   24145.54546554  .00015501  00000-0  27863-3 0  9993'
            line2 = '2 25544  51.6416  20.3541 0004943 234.3312 254.1254 15.49964522454457'
            from skyfield.api import EarthSatellite
            ts = load.timescale()
            satellite = EarthSatellite(line1, line2, 'ISS (FALLBACK)', ts)
        return satellite
