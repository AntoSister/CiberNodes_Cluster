...
#define SCH_SW_VERSION              "3.0.0.rc-2-30-g213c"  ///< Software version

/* Log system configurations*/
#define SCH_LOG_LEVEL               LOG_LVL_INFO  ///< LOG_LVL_INFO |  LOG_LVL_DEBUG
/* #undef SCH_LOG_ENABLE_MONGODB */
#define SCH_LOG_MONGODB_HOST        "localhost"  ///< Mongo db host
#define SCH_LOG_MONGODB_PORT        27017  ///< Mongo db port
#define SCH_LOG_MONGODB_NAME        "suchai-log"  ///< Mongo db database name
