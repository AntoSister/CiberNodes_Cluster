...
### :new: Check the new version [SUCHAI Flight Software v2](https://gitlab.com/spel-uchile/flight-software/suchai-flight-software-v2). This repository is no longer maintained.
